...
<template>
  ...
  <header :class="{
    ...
    <div class="container">
      <!-- logo -->
      <div class="logo" title="Oskhar">
        <h1><router-link to="/">Oskhar</router-link></h1>
      </div>
          ...
          <div class="container">
            ...
            <ul class="contact-info row">
              <li class="col-lg-4">
                ...
                <ul>
                  <li>
                    <a href="mailto:muhamadoskhar@gmail.com">muhamadoskhar@gmail.com</a>
                  </li>
                </ul>
              </li>
              <li class="col-lg-4">
              ...
              <li class="col-lg-4">
                ...
                <ul>
                  <li><a href="tel:02966202290">(62) 813 8638 0481</a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <ul class="options-icons">
        ...
        <li class="theme-switcher">
          <button :class="savedTheme" title="Change Mode" @click="() => {
              changeAppTheme()
              toggleDark()
            }
            "></button>
        ...
        <li class="hamburger-btn" :class="{ open: isNavMenuOpen }">
          <button ref="navMenuToggleBtn" title="Toggle Side Menu" aria-label="Toggle Side Menu" @click="toggleNavMenu">
            <span />
            <span />
            <span />
          </button>
